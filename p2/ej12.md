...
$foldPoli\ e\ id\ (+)\ (*)\ X\ * foldPoli\ e\ id\ (+)\ (*)\ q = foldPoli\ e\ id\ (+)\ (*)\ q\ * foldPoli\ e\ id\ (+)\ (*)\ X $

$foldPoli\ e\ id\ (+)\ (*)\ X\ * foldPoli\ e\ id\ (+)\ (*)\ q = foldPoli\ e\ id\ (+)\ (*)\ q\ * foldPoli\ e\ id\ (+)\ (*)\ X $

$e * foldPoli\ e\ id\ (+)\ (*)\ q = foldPoli\ e\ id\ (+)\ (*)\ q\ * e $

Por la `conmutatividad` de (*)

$e * foldPoli\ e\ id\ (+)\ (*)\ q = e * foldPoli\ e\ id\ (+)\ (*)\ q $
...
$foldPoli\ e\ id\ (+)\ (*)\ (Cte\ a)\ * foldPoli\ e\ id\ (+)\ (*)\ q = foldPoli\ e\ id\ (+)\ (*)\ q\ * foldPoli\ e\ id\ (+)\ (*)\ (Cte\ a) $

$Cte\ a * foldPoli\ e\ id\ (+)\ (*)\ q = foldPoli\ e\ id\ (+)\ (*)\ q\ * Cte\ a $

Por la `conmutatividad` de (*)

$Cte\ a * foldPoli\ e\ id\ (+)\ (*)\ q = Cte\ a * foldPoli\ e\ id\ (+)\ (*)\ q $
...
$foldPoli\ e\ id\ (+)\ (*)\ (Suma\ p_1\ p_2)\ * foldPoli\ e\ id\ (+)\ (*)\ q = foldPoli\ e\ id\ (+)\ (*)\ q\ * foldPoli\ e\ id\ (+)\ (*)\ (Suma\ p_1\ p_2) $
...
$foldPoli\ e\ id\ (+)\ (*)\ (Prod\ p_1\ p_2)\ * foldPoli\ e\ id\ (+)\ (*)\ q = foldPoli\ e\ id\ (+)\ (*)\ q\ * foldPoli\ e\ id\ (+)\ (*)\ (Prod\ p_1\ p_2) $
